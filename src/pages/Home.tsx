...
const DEFAULT_MANDALAS_BY_LEVEL: Record<Difficulty, string[]> = {
  basic: ["arbol1", "flor", "mariposa", "sol", "hoja", "arbol2", "pez", "buho"],
  intermediate: [
    "alegria",
    "nube",
    "furia",
...
const BASE_MANDALAS: MandalaDefinition[] = [
  ...
  {
    id: "nat10",
    aliases: ["nat10", "nube", "tristeza", "m10"],
    name: "Nube",
    level: "intermediate",
  ...
  {
    id: "nat16",
    aliases: ["nat16", "rubor", "verguenza", "m16"],
    name: "Rubor",
    level: "intermediate",
  ...
  {
    id: "nat17",
    aliases: ["nat17", "hexagonos", "geo1", "m17"],
    name: "Hexagonos",
    level: "advanced",
  ...
  {
    id: "nat18",
    aliases: ["nat18", "masaico", "mosaico", "geo2", "m18"],
    name: "Masaico",
    level: "advanced",
  ...
  {
    id: "nat19",
    aliases: ["nat19", "constelacion", "geo3", "m19"],
    name: "Constelacion",
    level: "advanced",
  ...
  {
    id: "nat20",
    aliases: ["nat20", "galaxia", "geo4", "m20"],
    name: "Galaxia",
    level: "advanced",
  ...
  {
    id: "nat21",
    aliases: ["nat21", "laberinto", "geo5", "m21"],
    name: "Laberinto",
    level: "advanced",
  ...
  {
    id: "nat24",
    aliases: ["nat24", "octagonal", "mandala-octagonal", "geo8", "m24"],
